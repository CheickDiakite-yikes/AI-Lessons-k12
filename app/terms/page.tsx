    ...
    <div className="min-h-[100dvh] bg-[var(--color-whisper-white)] font-sans text-[var(--color-deep-ink)] flex flex-col">
      ...
      <main className="flex-1 md:py-24 md:px-6 max-w-4xl mx-auto w-full">
        <div className="bg-[var(--color-crisp-page)] border-b-4 md:border-4 border-[var(--color-deep-ink)] p-6 md:p-12 md:shadow-[8px_8px_0px_0px_var(--color-deep-ink)]">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-black mb-8 uppercase">Terms of Service</h1>
          <div className="space-y-6 text-base sm:text-lg text-[var(--color-charcoal-grey)] font-medium leading-relaxed">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-[var(--color-deep-ink)] mt-8 mb-4 uppercase">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-black text-[var(--color-deep-ink)] mt-8 mb-4 uppercase">2. Use License</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-black text-[var(--color-deep-ink)] mt-8 mb-4 uppercase">3. Disclaimer</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-black text-[var(--color-deep-ink)] mt-8 mb-4 uppercase">4. Limitations</h2>
